...
\begin{document}
    ...
    \begin{lemma}
        ...
        Suppose \(x\), \(y \in G\) satisfy the dihedral relation \(xy = yx^{-1}\), and \(y^2=e\). Then
        \begin{align*}
            yx^l = x^{-l}y
        \end{align*}
        for any \(l \in \ZZ\).        
    ...
    \begin{proof}
        By the lemma, there is a homomorphism \(\phi: D_{2n} \to G\). \(\phi\) is surjective since \(\{a, b\}\) generate \(G\). Since \(|D_{2n}| = 2n = |G|\), it must be a bijection. The result follows.
    \end{proof}
    ...
    \begin{proof}
        ...
        \begin{enumerate}[label=\protect\circled{\arabic*}]
            ...
            \item Let \(b' = -z_1'\) and \(\mu_2 = \beta_{b'}\), that is \(\mu_2(z) = z + b'\). Observe \(\mu_2(\infty) = \infty\) and \(\mu_2(z_1') = 0\). Then by construction we have
            \begin{align*}
    ...
    \begin{proof}
        ...
        \begin{align*}
            ...
            \iff \frac{1}{|z|^2} - \frac{c}{\bar z} - \frac{\bar c}{z} + |c|^2 - r^2 &= 0 \\
